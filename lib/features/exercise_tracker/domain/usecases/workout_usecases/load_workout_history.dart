...
class LoadWorkoutHistory implements UseCase1<List<WorkoutHistoryEntity>, LoadWorkoutHistoryParams> {
  final WorkoutRepository repository;

  LoadWorkoutHistory(this.repository);

  @override
  Future<Either<Failure, List<WorkoutHistoryEntity>>> call(LoadWorkoutHistoryParams params) async {
