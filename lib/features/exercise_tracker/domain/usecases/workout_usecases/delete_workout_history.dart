...
class DeleteWorkoutHistory
    implements UseCase1<Unit, DeleteWorkoutHistoryParams> {
  ...
  Future<Either<Failure, Unit>> call(DeleteWorkoutHistoryParams params) async {
    return await repository.deleteWorkoutHistory(
      params.exerciseId,
      params.workoutId,
    );
  }
...
class DeleteWorkoutHistoryParams extends Equatable {
  ...
  const DeleteWorkoutHistoryParams({
